...
### 3. 多账号原生管理与底栏一体化交互
深度集成无限动态账号池，点击底栏头像一键切换，支持独立配额监控与高质感悬浮提示：

| 多账号额度管理与快捷切换面板 | 底栏头像一体化快捷切换入口与悬浮窗 |
| :---: | :---: |
...
| 深度汉化主界面 · 真实上下文五段式占比卡片 · 实时额度看板 |
| :---: |
| <img src="assets/verified_anti_freeze_live.png" width="750" /> |

### 动态多账号快捷切换与配额管理 (Multi-Account Switcher)
...
- **一键极速切换**：点击即切，自动同步刷新 Access Token 并写入系统凭据库，彻底避免跨账号凭证串号或会话混乱。
...
- **底部品牌与开源信息卡片**：底部原生集成「作者信息」、「软件型号」及「开源地址 (View Code ↗)」三联卡片，支持一键在浏览器打开 GitHub 仓库。

| 现代浅色模式 (自带作者/型号/GitHub主页底栏) | 深色极夜模式 (一键切换) |
| :---: | :---: |
| <img src="assets/gui_installer_light_preview.png" width="450" /> | <img src="assets/gui_installer_dark_preview.png" width="450" /> |
